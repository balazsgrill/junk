 ...
 * $Id$
 */
package package_.subpackage.util;
...
public class SubpackageAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SubpackageSwitch modelSwitch =
		new SubpackageSwitch() {
	...
	/**
	 * Creates a new adapter for an object of class '{@link package_.subpackage.A <em>A</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link package_.subpackage.B <em>B</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link package_.subpackage.C <em>C</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
